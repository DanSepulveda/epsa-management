...
// USER CONTROLLERS
router.route('/signup').get(validateUser, userControllers.createUser)

router.route('/login').get(validateUser, userControllers.login)

router.route('/user').put(validateUser, userControllers.editUser)
...
router
  ...
  .put(validateUser, recordsControllers.getRecords)
...
router.route('/monthly-report').post(validateUser, reportsControllers.monthlyReport)
