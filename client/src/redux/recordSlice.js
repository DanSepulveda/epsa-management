...
export const createRecord = createAsyncThunk('createRecord', async ({ values, token }) => {
...
export const getRecords = createAsyncThunk('getRecords', async (token) => {
...
export const editRecord = createAsyncThunk('editRecord', async ({ values, id, token }) => {
...
export const deleteRecord = createAsyncThunk('deleteRecord', async ({ id, token }) => {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(editRecord.fulfilled, (state, action) => {
        ...
        if (success) {
          state.records = [
            ...state.records.filter((activity) => activity._id !== response._id),
            response,
